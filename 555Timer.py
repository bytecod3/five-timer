...
class Main:
    def __init__(self, parent):
        ...
        self.pinout_diagram = ImageTk.PhotoImage(Image.open('pinout.jpg'))
    ...
    def astable(self):
        ...
        # get the current inputted values
        ...
        if r1_status is False:
            showwarning(title="Error", message="Enter numerical values only")

        elif r2_status is False:
            showwarning(title="Error", message="Enter numerical values only")

        elif cap_status is False:
            showwarning(title="Error", message="Enter numerical value only")
        ...
        if len(resistance_one) == 0:
            ...
            # low time
            low_time = 0.694 * resistance_two * capacitor
